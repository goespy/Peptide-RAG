...
| 6. Final evaluation and submission | In progress: offline runner, CI, cost projection, and local service-memory evidence complete; owner labels, RAG holdout, and deployment pending |
