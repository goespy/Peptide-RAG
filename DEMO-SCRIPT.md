...
- Public URL: `TBD`
- Last CI-tested hardening baseline: `8785c40` (`302` tests; the final post-holdout release commit remains `TBD`)
- Current local handoff-tree test count: `305`; final CI-tested count: `TBD`
