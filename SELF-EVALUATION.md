...
| Deployment smoke and owner handoff audit | `scripts/smoke_deployment.py`; `tests/test_smoke_deployment.py`; `artifacts/section6/deployment_smoke.json`; public UI captures | Pass: deployed-runtime CI run 32071964692 passed 307 tests; final suite passes 308 locally; offline runner, public smoke, and controlled rate-limit smoke (HTTP 429 exactly at probe 30) pass; `qa17` validates the model-originated refusal |
