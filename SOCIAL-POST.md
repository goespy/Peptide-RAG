...
>
> Measured result: [BOOLEAN BASELINE] → [FINAL LEXICAL/HYBRID RESULT]. The final system reached [FAITHFULNESS] faithfulness and [REFUSAL RATE] correct refusal on its untouched QA holdout.
>
> Demo: [DEMO URL]
>
